...
class Groupdetails extends StatefulWidget {
  ...
  List grpperson;
  String assetimg;
  Groupdetails(this.title, this.uid, this.grpperson, this.assetimg, this.grpid);
  @override
...
class _GroupdetailsState extends State<Groupdetails> {
  Stream<http.Response> getmsg() async* {
    ...
    yield await getmsga(widget.grpid);
  }
  ...
  Future fetchexp() async {
    ...
    var response = await http.post(
        Uri.parse('https://kaiaexp.000webhostapp.com/split/getsplitgrp.php'),
  ...
  Future sendmsg() async {
    var dat = {
      'grp_id': widget.grpid,
      'sender_id': _firebaseServices.getUserId(),
      'msg': _textController.text,
    };
    var response = await http.post(
        Uri.parse('https://kaiaexp.000webhostapp.com/chats/sendmsg.php'),
        body: json.encode(dat),
        headers: {"Accept": "application/json"});
        ...
        title: MaterialButton(
            onPressed: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => Groupdetaailsa(widget.title, widget.uid,
                      widget.grpperson, widget.assetimg, name)));
            },
            child: Row(children: [
              Container(
                height: 35,
